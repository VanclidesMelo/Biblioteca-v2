...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        categoria_misterio = Categoria.objects.create(nome="Misterio")
        ...
        autor_emily_bronte = Autor.objects.create(nome="Emily Bronte")
        ...
        Livro.objects.create(
            titulo="Assasinato no Expresso do Oriente",
